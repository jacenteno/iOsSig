        ...
        Task {
            do {
                ...
                DispatchQueue.main.async {
                    ...
                    self.totalDescuentos = salesData.totalDescuentos ?? TotalDescuentosItem(totalTransacciones: 0, totalDescuento: 0.0)
                    self.totalDescuentos2 = salesData.totalDescuentos2 ?? TotalDescuentos2Item(totalTransacciones: 0, totalDescuento: 0.0)
