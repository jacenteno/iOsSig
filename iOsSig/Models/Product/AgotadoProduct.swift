...
struct AgotadoProduct: Codable, Identifiable {
  ...
  init(from decoder: Decoder) throws {
    ...
    codbodega = try container.decode(String.self, forKey: .codbodega).trimmingCharacters(
      in: .whitespacesAndNewlines)
    codproducto = try container.decode(String.self, forKey: .codproducto).trimmingCharacters(
      in: .whitespacesAndNewlines)
    ...
    codigobarra = try container.decode(String.self, forKey: .codigobarra).trimmingCharacters(
      in: .whitespacesAndNewlines)
