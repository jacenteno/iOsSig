...
struct Product: Codable, Identifiable {
  ...
  enum CodingKeys: String, CodingKey {
    case codcompania, codbodega, coddep, desproducto, detalle, codigobarra, codproducto,
      codproveedor, referencia, nombre_departamento, ultcosto, existencias, ubicacion, ofertas,
      ucosto, costofob, indexproductos, costooriginal, preciodeventa, fvencimiento, ctacontable,
      bloqueofacturacion, gravadoexecto, prcimpuestoventa, nombre_lista_precio, listas_de_precio,
      series_asociadas, codigo_consultado, lista_referencia
  }
}
