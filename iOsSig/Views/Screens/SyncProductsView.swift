    ...
    Section {
      VStack(alignment: .center, spacing: 16) {
        Image(systemName: "arrow.triangle.2.circlepath.icloud.fill")
          ...
          .foregroundStyle(
            LinearGradient(
              colors: [.accentColor, .accentColor.opacity(0.7)], startPoint: .top, endPoint: .bottom
            ))
...
private struct DepartmentSelectionSection: View {
  ...
  var body: some View {
    Section(
      header: Text("Seleccionar Departamentos"),
      footer: Text("Selecciona los departamentos que deseas sincronizar.")
    ) {
      HStack {
