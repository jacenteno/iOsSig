  ...
  extension CartManager {
    static var sampleForPreview: CartManager {
      ...
      let anotherProduct = Product(
        codcompania: 1, codbodega: "B02", coddep: 12,
        desproducto: "Otro Producto de Prueba Con un Nombre Muy Largo para ver como se corta",
        detalle: nil, codigobarra: "987654321", codproducto: "PROD-002", codproveedor: nil,
        referencia: "REF-002", nombre_departamento: "Hogar", ultcosto: 50.0, existencias: 200,
        ubicacion: nil, ofertas: nil, ucosto: nil, costofob: nil, indexproductos: 2,
        costooriginal: nil, preciodeventa: 79.99, fvencimiento: nil, ctacontable: nil,
        bloqueofacturacion: nil, gravadoexecto: nil, prcimpuestoventa: nil,
        nombre_lista_precio: nil, listas_de_precio: nil, series_asociadas: nil,
        codigo_consultado: nil, lista_referencia: nil
      )
