            ...
            if viewModel.isLoading && viewModel.products.isEmpty {
                ...
                if viewModel.searchText.isEmpty {
                    EmptyStateView(
                        ...
                        message: "No hay productos locales. Sincronice los productos para poder consultarlos sin conexión."
                    )
                } else {
                    EmptyStateView(
...
private struct ProductRow: View {
    ...
    var body: some View {
        ...
        .cornerRadius(16)
        .shadow(color: Color.black.opacity(isPressed ? 0.15 : 0.08), radius: isPressed ? 12 : 8, x: 0, y: isPressed ? 6 : 4)
