...
//  test
//
//  Created by Jorge Centeno on 10/28/25.
//
...
class BluetoothDeviceLocator: NSObject, DeviceLocator, CBCentralManagerDelegate {
  ...
  func startScanning() {
    ...
    let exampleServiceID = CBUUID(string: "1B65DF80-CFF8-4E14-9881-880ED4B63773")
  ...
  func centralManager(
    ...
    let exampleDeviceName =
      advertisementData[CBAdvertisementDataLocalNameKey] as? String ?? "Unknown"
    ...
    let device = DDDevice(
      displayName: exampleDeviceName, category: .hifiSpeaker, protocolType: exampleDeviceProtocol,
      identifier: exampleDeviceIdentifier)
